      ...
      <main className="home">
        ...
        <div className="departamentos-grid">
          ...
          <DepartamentoCard 
            ...
            path="/convencion1994"  // Corregido: agregada la "n" que faltaba
            ...
            <div className="row">
              <div className="col-md-4 mb-4">
                <div className="location-card">
                  ...
                  <Link to="/ugarteche2824" className="btn btn-primary">
              ...
              <div className="col-md-4 mb-4">
                <div className="location-card">
                  ...
                  <Link to="/santafe3770" className="btn btn-primary">
                    <i className="fas fa-info-circle"></i> Más Información
                  </Link>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="location-card">
                  ...
                  <Link to="/moldes1680" className="btn btn-primary">
                    <i className="fas fa-info-circle"></i> Más Información
                  </Link>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="location-card">
                  ...
                  <Link to="/convencion1994" className="btn btn-primary">
                    <i className="fas fa-info-circle"></i> Más Información
                  </Link>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="location-card">
                  ...
                  <Link to="/dorrego1548" className="btn btn-primary">
                    <i className="fas fa-info-circle"></i> Más Información
                  </Link>
                </div>
              </div>
