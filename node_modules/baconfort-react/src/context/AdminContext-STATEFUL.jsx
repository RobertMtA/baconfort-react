    ...
    try {
      ...
      try {
        ...
        if (savedProperties) {
          ...
          // 🔧 VERIFICACIÓN: Si localStorage tiene datos obsoletos con títulos incorrectos, limpiarlo
          ...
          if (hasObsoleteData) {
            console.log('🧹 AdminProvider: Detectados datos obsoletos en localStorage, limpiando...');
            localStorage.removeItem('baconfort_admin_properties');
            localProperties = {};
          } else {
      ...
      // Combinar todas las fuentes: backend + estado inicial + localStorage
      const combinedProperties = {
        ...properties, // Estado inicial (fallback siempre disponible)
        ...propertiesObject, // Backend (sobrescribe estado inicial)
        ...localProperties // localStorage (prioridad máxima sobre todo)
      };
